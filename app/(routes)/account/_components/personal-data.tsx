  ...
  return (
    <div className="flex flex-col gap-3">
      <Button
        ...
        variant="ghost"
        className={`p-0 flex items-center justify-between text-[#484848] ${activeNavigation === 'personal-data' ? 'font-bold' : "font-semibold"}`}
      >
        Особисті дані
        <ArrowDown  className={`${activeNavigation === 'personal-data' && 'rotate-180'} transform transition-all duration-150 lg:hidden`}/>
      </Button>
